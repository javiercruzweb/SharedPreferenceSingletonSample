package mx.javiercruzweb.sharedpreferencesingletonsample.utils;
...
public class GlobalSettings {
    ...
    private static final String SETTINGS_NAME = "global_settings";
    private static GlobalSettings sSharedPrefs;
     ...
     */
    public enum Key {
        GLOBAL_SETTINGS_SOUND,
        GLOBAL_SETTINGS_NOTIFICATIONS,
        GLOBAL_SETTINGS_RADIO
    ...
    public static GlobalSettings getInstance(Context context) {
        if (sSharedPrefs == null) {
            sSharedPrefs = new GlobalSettings(context.getApplicationContext());
        }
        return sSharedPrefs;
    }
